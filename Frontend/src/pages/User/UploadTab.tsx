 ...
 * - Folder batch upload via directory picker
 * - Real-time upload queue with progress and status indicators
 * - Upload summary statistics (total, completed, in-progress, failed)
 */
...
/*
 * File upload component with drag-and-drop zone, file/folder pickers,
 * upload queue tracking, and summary statistics panel.
 *
 * @param role - Current user's role (passed through for future permission checks)
 */
export function UploadTab({ role }: { role: Role }) {
    ...
    /*
     * Uploads a single file to the server and tracks its progress in the queue.
     * Generates a unique queue ID for tracking, updates status on completion or error.
     *
     * @param file - The File object to upload
     */
    const uploadSingleFile = async (file: File) => {
        // Generate a unique ID for this queue entry using timestamp + random suffix
    ...
    /*
     * Processes multiple files for individual upload.
     * Each file is uploaded independently via uploadSingleFile.
     *
     * @param files - FileList or File array from the file picker or drop event
     */
    ...
    /*
     * Uploads an entire folder as a batch via the folder upload API endpoint.
     * All files share a single API call; their queue statuses are updated together.
     *
     * @param files - FileList or File array from the directory picker
     */
